...
ggplot(d) + 
  ...
  geom_vline(aes(Clusters, xintercept = best_BIC, color = "BIC"), linetype = "dashed") +
  geom_vline(aes(Clusters, xintercept = best_AIC, color = "AIC"), linetype = "dashed") +
  geom_vline(aes(Clusters, xintercept = best_AICc, color = "AICc"), linetype = "dashed") +
