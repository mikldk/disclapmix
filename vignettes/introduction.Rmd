...
The column `N` is the number of individuals in the population with that Y-STR haplotype. Summing column `N` reveals that there is not exactly `pop\_size` individuals due to that the population size is stochastic (refer to [@fwsimArxiv] for the details).
